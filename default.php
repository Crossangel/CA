...
<!DOCTYPE html>
    ...
    <head> 
        ...
        <link rel="icon" type="image/x-icon" href="logoslagi.png">
        ...
        <main class="main">
                        ...
                        <div class="home__img">
                            <svg class="home__blob" viewBox="0 0 200 187" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <g mask="url(#mask0)">
                                    ...
                                    <image class="home__blob-img" x='15' y='10' xlink:href="logoslagi1.png"/>
                                </g>
                            </svg>
                        </div>

                        <div class="home__data">
                            <h1 class="home__title">PS Woodball</h1>
                            ...
                            <a href="ulogin.php" class="button button--flex">
                                Let's Play<i class="uil uil-message button__icon"></i>
                            </a>
                            <a href="ulogin.php" class="button button--flex">
            ...
            <section class="about section" id="about">
                ...
                <div class="about__container container grid">
                    <img src="lecture.jpg" alt="" class="about__img">
                

                <div class="about__data">
                    <p class="about__description"><b>Fauziah Binti Besok</b><br>Lecturer DH48<br>Information Technology and Communication Department, fauziah@psmza.edu.my</p>
                             ...
                             <div class="achievement__data">
                                ...
                                <div>
                                    ...
                                    <span class="achievement__subtitle">Kejohanan Petanque (MASKOM 2022)
                                        <img src="Kejohanan_Petanque2022.jpg">
                                    </span>
                                    <div class="achievement__calendar">
                                        <i class="uil uil-calendar-alt">
                                            2022
                ...
                <div class="robottype__container container swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="robottype__content grid swiper-slide">
                            <img src="equipment.jpeg" alt="" class="robottype__img">
                        ...
                        <!--==================== Robot Type 2====================-->
                        <div class="robottype__content grid swiper-slide">
                            <img src="rules.jpg" alt="" class="robottype__img">
            ...
            <section class="joinUs section">
                <div class="joinUs__bg">
                    <div class="joinUs__container container grid">
                        ...
                        <img src="img/logo.png" alt="" class="joinUs__img">
                    </div>
                </div>
            </section>
                ...
                <div class="developTeam__container container swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="developTeam__content swiper-slide">
                            <div class="developTeam__data">
                                <div class="developTeam__header">
                                    <img src="sahif.jpg" alt="" class="developTeam__img">
                        ...
                        <div class="developTeam__content swiper-slide">
                            <div class="developTeam__data">
                                <div class="developTeam__header">
                                    <img src="Azidpicture.png" alt="" class="developTeam__img">
                        ...
                        <div class="developTeam__content swiper-slide">
                            <div class="developTeam__data">
                                <div class="developTeam__header">
                                    <img src="jijo.jpg" alt="" class="developTeam__img">
